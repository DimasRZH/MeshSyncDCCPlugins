...
1. Open `Packages/MeshSync DCC Plugins/Editor/Plugins` folder using a file explorer 
   ...
   For Blender 4.5, 5.0 or 5.1 on Windows, select `blender-4.5.14.zip`, `blender-5.0.0.zip` or `blender-5.1.1.zip`; MeshSync 0.17.3 does not auto-detect these versions yet.
1. Start Blender
